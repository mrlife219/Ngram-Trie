# Source: https://github.com/huggingface/transformers/blob/v4.41-release/src/transformers/models/qwen2/modeling_qwen2.py
...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        # [MODIFIED] Don't constrain past_key_value to be KVCache class
        ...
        if past_key_value is not None:
            # [MODIFIED] use medusa-like kv_cache to store kv
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
        # [MODIFIED] past_key_value is KVCache class
